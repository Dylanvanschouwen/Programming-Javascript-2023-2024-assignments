...
if (!isNaN(productPrice)) {
    if (Budget >= productPrice) {
        ...
        ResultP.innerHTML = "Helaas, te weinig geld om het product te kopen. Budget: " + Budget + " Productprijs: " + productPrice;
        ResultP.style.color = "red";
    }
} else {
    ResultP.innerHTML = "Ongeldige invoer. Voer een geldig getal in voor de productprijs.";
    ResultP.style.color = "red";
}
